        ...
        <div className="client-layout">
          <div className="client-sidebar">
            <div className="client-card">
              <h3 className="client-name">Bob Williams</h3>
              <p className="client-subtext">Contact Information</p>
              <p className="client-contact-row"><FaEnvelope /> bob.w@example.com</p>
              <p className="client-contact-row"><FaPhone /> 555-0102</p>
            </div>
